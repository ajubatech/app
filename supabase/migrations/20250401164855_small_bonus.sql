/*
  ...
  2. Constraints
    - Valid transmission values (automatic, manual)
    - Valid fuel type values (petrol, diesel, hybrid, electric, lpg)
    - Valid body type values (sedan, suv, hatchback, wagon, coupe, convertible, ute, van)
